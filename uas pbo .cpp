...
void displayDatajoin(MYSQL* conn){
    ...
    if (conn){
        ...
        if(!qstate){
            ...
            cout << "==============LIST DATA==============\n";
            cout <<"\tID\tNim\tNama\tcreated_at\t\tupdtae_at\t\tID\tKD_dosen\tNama_dosen\tcreated_at\tupdtae_at\n";
...
void displayDatadosen(MYSQL* conn){
    ...
    if (conn){
        ...
        if(!qstate){
            ...
            int count = mysql_num_fields(res);
            cout << "==============LIST DATA==============\n";
            cout <<"\tID\tKD_dosen\tNama_dosen\tcreated_at\tupdtae_at\n";
            while(row = mysql_fetch_row(res)){
                for(int i=0; i<count;i++){
                    cout <<"\t"<<row[i];
                }
    ...
    do{
        ...
        switch(pilih){
            ...
            case 1:
                ...
                break;
            case 2:
				insertDatadosen(conn);
                displayDatadosen(conn);
                break;
            case 3:
